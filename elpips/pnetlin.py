...
class PNetLin(object):
	...
	def forward(self, in0, in1):
		...
		with tf.name_scope("PNetLin"):
			...
			tf.print("!!!!!!!!in 0: ", tf.reduce_mean(in0_sc), output_stream=sys.stdout)
			tf.print("!!!!!!!!in 1: ", tf.reduce_mean(in1_sc), output_stream=sys.stdout)
			...
			tf.print("!!!!!!!!loss: ", losses, output_stream=sys.stdout)
